...
# Create sample users
User.create!([
  {username: "admin", email: "admin@playerly.com", fname: "John", lname: "Doe", bio: "Have you seen my sister, Jane?", dob: Date.new(1990, 1, 1), password: "p@ssW0rd", password_confirmation: "p@ssW0rd", gender_id: 1, profile_image: "", city: "Melbourne", post_code: "3000", last_active: Date.new(2020, 4, 10), is_private: true, is_active: true, is_banned: false},
  {username: "longcyclist", email: "longcyclist@email.com", fname: "Michaela", lname: "Long", bio: "I wheelie love riding my bike!", dob: Date.new(1998, 3, 12), password: "p@ssW0rd", password_confirmation: "p@ssW0rd", gender_id: 2, profile_image: "", city: "Melbourne", post_code: "3000", last_active: Date.new(2020, 4, 26), is_private: false, is_active: true, is_banned: false},
  {username: "bballbrandon", email: "bballbrandon@email.com", fname: "Brandon", lname: "Gutierrez", bio: "I used to be addicted to basketball... but I rebounded.", dob: Date.new(1980, 11, 3), password: "p@ssW0rd", password_confirmation: "p@ssW0rd", gender_id: 1, profile_image: "", city: "Melbourne", post_code: "3000", last_active: Date.new(2020, 3, 31), is_private: false, is_active: true, is_banned: false},
  ...
  {username: "arrowtoknee", email: "arrowtoknee@email.com", fname: "Mark", lname: "Clark", bio: "Have you ever tried blind-folded archery? You don't know what you're missing.", dob: Date.new(1998, 8, 10), password: "p@ssW0rd", password_confirmation: "p@ssW0rd", gender_id: 1, profile_image: "", city: "Brisbane", post_code: "4000", last_active: Date.new(2020, 3, 3), is_private: false, is_active: true, is_banned: true},
  ...
  {username: "innerpeace", email: "innerpeace@email.com", fname: "Matt", lname: "Scott", bio: "I can tell you a pun, but it might be a bit of a stretch...", dob: Date.new(1979, 12, 18), password: "p@ssW0rd", password_confirmation: "p@ssW0rd", gender_id: 1, profile_image: "", city: "Geelong", post_code: "3220", last_active: Date.new(2020, 4, 25), is_private: false, is_active: true, is_banned: false}
])
...
Group.create!([
  ...
  {sport_id: 4, name: "Gorillaz", description: "Gorillaz is a professional basketball team based in Melbourne, Victoria - known to compete in the National Basketball League and plays their home game at Melbourne Arena.", profile_image: "", approval_type_id: 2, group_type_id: 2, has_skill_requirement: true, skill_level_id: 3, has_max_capacity: true, max_capacity: 20, email: "enquiries@gorillaz.com", phone: "", address: "90 Collins St", city: "Melbourne", state: "Victoria", post_code: "3000", is_private: true, is_active: true, is_banned: false},
  {sport_id: 14, name: "Macquarie Golf Club", description: "One of Australia's pre-eminent private clubs, we take pride in our love of the sport.", profile_image: "", approval_type_id: 2, group_type_id: 1, has_skill_requirement: true, skill_level_id: 2, has_max_capacity: false, max_capacity: 0, email: "contact@maquariegc.com", phone: "0292320763", address: "233 Maquarie St", city: "Sydney", state: "New South Wales", post_code: "2000", is_private: true, is_active: true, is_banned: false}
])
